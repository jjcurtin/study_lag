...
test_metrics_all_perf |> 
  write_csv(file.path(path_models_lag, "test_metrics_all.csv"))
```
...
test_metrics_all_pp_perf |> 
  write_csv(file.path(path_models_lag, "test_metrics_all_pp_perf.csv"))
```
...
ci_baseline |> 
  write_csv(file.path(path_models_lag, "ci_baseline.csv"))
...
ci_lag |> 
  write_csv(file.path(path_models_lag, "ci_lag.csv"))
```
