...
pp_tidy |> 
  ...
  geom_histogram(aes(x = posterior), fill = "light grey", color = "black", alpha = .4, 
                 bins = 30) +
  geom_segment(mapping = aes(y = 2200, yend = 2600, x = pp_median, xend = pp_median),
               data = ci) +
  geom_segment(mapping = aes(y = 2400, yend = 2400, x = pp_lower, xend = pp_upper),
                data = ci) +
...
### Figure S2: Calibration Plots for Baseline and 2-Week Lag Models
