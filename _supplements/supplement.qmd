...
### Figure A. Model performance by model and timing of lapse
...
### Figure B. Calibration plots for all models

Figure B shows the calibration plots for the raw and calibrated probabilities for all five models. It also includes a histogram of raw probabilities along the x-axis to illustrate range of predictions and bin size.
...
### Figure D. Global Shapley plots for baseline and 2-week lag models by demographic subgroup

Figure D presents the global feature importance values separately by demographic subgroup for the no lag and 2-week lag models. The relative ordering of important features remained consistent across groups.  
...
### Table C. Brier scores for all models

The raw probabilities produced by our final models were not well calibrated. Consequently, we used Platt scaling to improve calibration. Table C presents Brier scores for the raw and Platt scaled probabilities for each model. 
