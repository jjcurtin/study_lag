...
<!--KW: John, I put enrollment and disposition in this section. I am not sure if it is confusing to put before the study procedure section. Let me know your thoughts-->
...
<!--KW: We only uses symtom count, demographics, and lapse counts to characterize the sample in our table/results. We do use Brief Symptom Inventory for exclusion criteria - I now cite that in earlier section - should I add it here too? We could also discuss adding some more characterization.-->
...
<!--is that income cut above correct?  Seems VERY low!-->
<!--KW: OMG I forgot a 0! Thanks for catching that! I actually had to rerun the fairness analyses. Numbers changed slightly but still same conclusion.-->
