...
<!--Demo use of embeded table from tables.qmd notebook-->
...
Alternatively, these images can be saved in a repository that is available via the web  

<!--insert demo of an image from my lectures repo-->
...
You can also reference other sections in the paper (e.g., Methods are described in @sec-methods)

You can reference them elsewhere using the @ symbol.   Here is a reference to @fig-1

We can also reference this type of figure elsewhere if we want (@fig-map).
