...
Ecological momentary assessment (EMA) may be the most feasible personal sensing data stream for these early JITAIs. It offers momentary subjective insight into constructs easily mapped onto the relapse prevention model [@marlattRelapsePreventionMaintenance1985; @witkiewitzRelapsePreventionAlcohol2004]. Thus, it can be an important signal for predicting lapses and interpreting important features for clinically intuitive intervention.
