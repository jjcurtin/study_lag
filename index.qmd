...
3. Tabke with auroc and confidence interval by protected group and lag 
4. figure for Shapley values

<!-- Kenda, lets talk about this. No need for code in index.qmd.  Can all live in notebooks now -->
...
<!-- degrades is pretty pessimistic!!  Can you reframe in a positive light? ;-) -->
