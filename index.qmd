...
Histograms of the raw predicted probabilities for the best model configuration for each model (no lag, 1-day, 3-day, 1-week, and 2-week lag) are presented in the supplement. Models were generally well-calibrated, indicating that predicted lapse probabilities aligned closely with observed lapse rates (see @fig-cal). Calibration was strongest for the no lag and 1-day lag models. Models with longer lags (1 week and 2 weeks) showed reduced calibration accuracy, particularly at higher predicted probabilities.
