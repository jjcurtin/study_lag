...
pp_dem_all |> 
  kbl(format = "simple",
      booktabs = TRUE,
      col.names = c("Group", "median PP for auROC", "Bayesian CI",
                    "median PP for auROC", "Bayesian CI", 
                    "median PP for auROC", "Bayesian CI",
                    "median PP for auROC", "Bayesian CI",
                    "median PP for auROC", "Bayesian CI"),
      digits = 3) |> 
  kable_styling() |> 
  add_header_above(c(" " = 1, "0 Lag" = 2, "24 Lag" = 2, "72 Lag" = 2,
                     "168 Lag" = 2, "336 Lag" = 2)) |> 
  pack_rows("Race/Ethnicity", 1, 2) |> 
  pack_rows("Sex", 3, 4) |> 
  pack_rows("Income", 5, 6) |> 
  pack_rows("Age", 7, 8)
```
