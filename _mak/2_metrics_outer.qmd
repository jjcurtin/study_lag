...
### Fit best model for each outer fold and get/save preds, SHAPs
...
Get test auROCs     
This calculates auROC using test sets (out loop held out folds). Uses probability corrected (prob_beta) probabilities.
...
metrics_test |> 
  ...
  write_csv(here::here(path_models, str_c("test_auroc_3_x_10_", window, "_", 
                                                      lead, "_", version, "_", 
                                                      cv, "_", model, ".csv"))) 
