...
each model by demographic group. All group comparisons for race, sex at
...
(range NA--0.179) for non-Hispanic White participants compared to
participants who were not White. On average there was a median increase
in auROC of -0.080 (range -0.059--0.116) for male participants compared
to female participants. On average there was a median increase in auROC
of -0.092 (range -0.086--0.133) for participants above the federal
poverty line compared to participants below the federal poverty line. A
table of model performance for each demographic group separately by
...
models. Overall, the contribution of a feature category to model
performance did not appear to differ across models.

Panel B shows the local feature importance scores colored by high or low
feature value for the 336 hour lag model. .
