...
```{r}
global_all <- read_rds(here::here(path_models_lag, "archive/shap_global_all.rds")) |> 
...
shaps <- read_rds(here::here(path_models_lag, "archive/outer_shapsgrp_1day_0_v3_nested_main.rds"))
...
shaps_336 <- read_rds(here::here(path_models_lag, "archive/outer_shapsgrp_1day_336_v3_nested_main.rds"))
