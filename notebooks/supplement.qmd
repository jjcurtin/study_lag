...
We saw similar patterns in global feature importance across different demographic subgroups (race/ethnicity, income, sex assigned at birth). Plots of global feature importance by demographic subgroup for the no lag and 2-week lagged models are presented below. 
...
pp_sex |> 
  ...
  kbl() |> 
  add_header_above(c(" " = 1, "Sex assigned at birth" = 3, "Income" = 3, "Race/Ethnicity" = 3))
```
