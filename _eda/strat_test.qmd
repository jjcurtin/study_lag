...
path_chtc <- format_path(str_c("studydata/risk/chtc/gps"))
```
...
strat_yn |> 
  ...
  ggplot() +
  geom_histogram(aes(x = roc_auc), bins = 15, color = "black", fill = "light grey")  +
  geom_vline(aes(xintercept = median(strat_yn_best$roc_auc)), color = "red")
```
...
strat_lh |> 
  ...
  ggplot() +
  geom_histogram(aes(x = roc_auc), bins = 15, color = "black", fill = "light grey")  +
  geom_vline(aes(xintercept = median(strat_lh_best$roc_auc)), color = "red")
```
...
strat_nlh |> 
  ...
  ggplot() +
  geom_histogram(aes(x = roc_auc), bins = 15, color = "black", fill = "light grey")  +
  geom_vline(aes(xintercept = median(strat_nlh_best$roc_auc)), color = "red")
```
